...
const playerDims = { x: 900, y: 20, width: 100, height: 100 };
const player = new Player(100, 4, 'blue', 'player', playerDims, manager.assets);
const appleDims = { x: 500, y: 50, width: 60, height: 60 };
const apple = new Item('an apple.', 'food', 'Apple', 64, appleDims, 'red', manager.assets);
const boxDims = { x: 800, y: 90, width: 75, height: 60 };
const box = new Item('a box.', 'weapon', 'Box', 1, boxDims, 'orange', manager.assets);
